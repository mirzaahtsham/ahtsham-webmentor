              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className={`${getCategoryColor(service.category)} text-white px-3 py-1 rounded-lg text-xs flex items-center gap-1.5 backdrop-blur-sm`}>
                      {service.categoryIcon}
                      {service.category}
                    </span>
                  </div>
                  <div className="absolute top-3 right-3 bg-black/70 backdrop-blur-sm text-white px-2 py-1 rounded-lg text-xs flex items-center gap-1">
