        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <h3 className="text-3xl md:text-4xl mb-4">
              <span className="text-transparent bg-clip-text bg-linear-to-r from-purple-400 via-pink-400 to-yellow-400">
                Multiple Technologies
              </span>
            </h3>
            <h3 className="text-3xl md:text-4xl mb-6">
              & <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-blue-400">Frameworks</span>
            </h3>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-4">
            {["Python", "Java", "PHP", "Vue", "Angular", "Firebase", "Redis", "PostgreSQL"].map((tech, index) => (
              <motion.div
                ...
                className="px-4 py-2 bg-linear-to-r from-purple-600 to-pink-600 rounded-full text-sm hover:shadow-lg hover:shadow-purple-500/50 transition-shadow"
              >
                {tech}
              </motion.div>
            ))}
