...
const courseData = {
  ...
  courseIncludes: [
    { icon: Play, text: "40 DVDs on-demand video" },
  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="bg-gray-900 rounded-2xl overflow-hidden border border-gray-800 sticky top-24">
                {/* Course Image */}
      ...
      <section className="pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="lg:w-2/3">
            <h2 className="text-3xl mb-6">Learner Reviews</h2>
